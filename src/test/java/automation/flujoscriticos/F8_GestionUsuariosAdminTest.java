...
public class F8_GestionUsuariosAdminTest extends BaseTestFlujos {
    ...
    public void verificarBotonCrearUsuario() {
        try {
            ...
            boolean botonCrearPresente = 
                ...
                isElementPresent(By.xpath("//*[contains(text(),'Crear') or contains(text(),'Agregar') or contains(text(),'Nuevo')]")) ||
    ...
    public void verificarOpcionRolAdmin() {
        try {
            ...
            boolean opcionAdmin = 
                isElementPresent(By.cssSelector("ion-toggle, ion-checkbox")) ||
                isElementPresent(By.xpath("//*[contains(text(),'Admin') or contains(text(),'admin') or contains(text(),'Administrador')]")) ||
