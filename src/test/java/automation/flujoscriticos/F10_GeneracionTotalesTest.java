...
public class F10_GeneracionTotalesTest extends BaseTestFlujos {
  ...
  public void verificarTotalIngresos() {
    try {
      ...
      boolean tieneIngresos = isElementPresent(
          By.xpath("//*[contains(text(),'Ingreso') or contains(text(),'ingreso')]")) ||
  ...
  public void verificarTotalEgresos() {
    try {
      ...
      boolean tieneEgresos = isElementPresent(By.xpath("//*[contains(text(),'Egreso') or contains(text(),'egreso')]"))
          ||
  ...
  public void verificarBalanceGeneral() {
    try {
      ...
      boolean tieneBalance = isElementPresent(By.xpath("//*[contains(text(),'Balance') or contains(text(),'balance')]"))
          ||
