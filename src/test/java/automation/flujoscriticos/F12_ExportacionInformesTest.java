...
public class F12_ExportacionInformesTest extends BaseTestFlujos {
  ...
  public void verificarExportacionIngresos() {
    try {
      ...
      boolean tieneExportacion = isElementPresent(
          By.xpath("//*[contains(text(),'Exportar') or contains(text(),'Export')]")) ||
          isElementPresent(By.xpath("//*[contains(text(),'Descargar') or contains(text(),'Download')]")) ||
          isElementPresent(
              By.xpath("//*[contains(text(),'PDF') or contains(text(),'Excel') or contains(text(),'CSV')]"))
          ||
  ...
  public void verificarTotalesComoInforme() {
    try {
      ...
      boolean tieneDatosResumen = isElementPresent(
  ...
  public void verificarFuncionalidadImpresion() {
    try {
      ...
      boolean tieneImpresion = isElementPresent(
          By.xpath("//*[contains(text(),'Imprimir') or contains(text(),'Print')]")) ||
  ...
  public void verificarDatosExportablesEmpresas() {
    try {
      ...
      boolean tieneDatosExportables = isElementPresent(
          By.xpath("//*[contains(text(),'Saldo') or contains(text(),'Total')]")) ||
          isElementPresent(By.xpath("//*[contains(text(),'$')]")) ||
  ...
  public void verificarPresentacionTabular() {
    try {
      ...
      boolean tienePresentacionTabular = isElementPresent(By.cssSelector("table, ion-list, ion-grid")) ||
  ...
  public void verificarResumenGlobal() {
    try {
      ...
      boolean tieneResumenIngresos = isElementPresent(By.xpath("//*[contains(text(),'Ingreso')]"));
      boolean tieneResumenEgresos = isElementPresent(By.xpath("//*[contains(text(),'Egreso')]"));
      boolean tieneBalance = isElementPresent(
          By.xpath("//*[contains(text(),'Balance') or contains(text(),'Saldo') or contains(text(),'Total')]"));
      boolean tieneValores = isElementPresent(By.xpath("//*[contains(text(),'$')]"));
