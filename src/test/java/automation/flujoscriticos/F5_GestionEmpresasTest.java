  ...
  public void verificarBotonCrearEmpresa() {
    try {
      ...
      boolean botonCrearPresente = isElementPresent(By.cssSelector("ion-fab-button, ion-button[color='primary']")) ||
          isElementPresent(
              By.xpath("//*[contains(text(),'Crear') or contains(text(),'Agregar') or contains(text(),'Nueva')]"))
          ||
  ...
  public void verificarInformacionEmpresa() {
    try {
      ...
      if (empresas.size() > 0) {
        ...
        boolean hayInformacion = isElementPresent(By.cssSelector("ion-card-content, ion-label, ion-text")) ||
  ...
  public void verificarAccesoEdicionEmpresa() {
    try {
      ...
      if (empresas.size() > 0) {
        ...
        boolean tieneOpcionEditar = isElementPresent(
            By.cssSelector("ion-button[fill='clear'], ion-icon[name='create'], ion-icon[name='pencil']")) ||
