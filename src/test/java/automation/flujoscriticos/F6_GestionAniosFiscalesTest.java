...
public class F6_GestionAniosFiscalesTest extends BaseTestFlujos {
    ...
    public void navegacionSeccionAnios() {
        try {
            ...
            boolean seccionAniosPresente = 
                isElementPresent(By.xpath("//*[contains(text(),'Año') or contains(text(),'año')]")) ||
    ...
    public void verificarBotonCrearAnio() {
        try {
            ...
            boolean opcionCrearAnio = 
                isElementPresent(By.xpath("//*[contains(text(),'Crear') and contains(text(),'Año')]")) ||
    ...
    public void verificarSelectorAnioActivo() {
        try {
            ...
            boolean muestraAnioActivo = 
                isElementPresent(By.xpath("//*[contains(text(),'" + anioActual + "')]")) ||
    ...
    public void verificarPersistenciaAnioSeleccionado() {
        try {
            ...
            boolean navegacionFuncional = 
                driver.getCurrentUrl().contains("ingreso") ||
                isElementPresent(By.cssSelector("ion-content"));
