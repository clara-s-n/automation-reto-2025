...
public class F11_RegistroPagosMultiplesTest extends BaseTestFlujos {
    ...
    public void verificarEstructuraFilasPagos() {
        try {
            ...
            boolean tieneEstructuraPagos = 
                isElementPresent(By.xpath("//*[contains(text(),'Pago') or contains(text(),'pago')]")) ||
    ...
    public void verificarSaldoPendiente() {
        try {
            ...
            boolean tieneSaldo = 
                isElementPresent(By.xpath("//*[contains(text(),'Saldo') or contains(text(),'Pendiente')]")) ||
                isElementPresent(By.xpath("//*[contains(text(),'$')]")) ||
    ...
    public void verificarCampoPagoInicial() {
        try {
            ...
            boolean tienePagoInicial = 
                isElementPresent(By.xpath("//*[contains(text(),'Pago') and contains(text(),'Inicial')]")) ||
    ...
    public void verificarBotonAgregarPago() {
        try {
            ...
            boolean botonPagoPresente = 
                isElementPresent(By.xpath("//*[contains(text(),'Agregar') or contains(text(),'Pagar') or contains(text(),'Abonar')]")) ||
    ...
    public void verificarEstadoFilasSegunSaldo() {
        try {
            ...
            boolean tieneEstados = 
                isElementPresent(By.xpath("//*[contains(text(),'Pagado') or contains(text(),'Pendiente') or contains(text(),'Parcial')]")) ||
                isElementPresent(By.cssSelector("ion-badge, ion-chip")) ||
    ...
    public void verificarEstructuraPagosEgresos() {
        try {
            ...
            boolean tieneEstructura = 
                isElementPresent(By.xpath("//*[contains(text(),'Pago') or contains(text(),'Saldo')]")) ||
                isElementPresent(By.xpath("//*[contains(text(),'$')]")) ||
